		...
		<div class="admin-main">
			...
			<form class="layui-form" action="">
				<div class="layui-form-item">
					<label class="layui-form-label" style="padding: 9px 5px;">发布日期：</label>
				    ...
				    <label class="layui-form-label" style="padding: 9px 5px;">商品类别：</label>
				    ...
				    <label class="layui-form-label" style="padding: 9px 5px;">商品名称：</label>
