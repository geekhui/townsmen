		...
		<div class="admin-main">
			...
			<form class="layui-form" action="">
				<div class="layui-form-item">
					<label class="layui-form-label" style="padding: 9px 5px;">活动时间：</label>
				    ...
				    <label class="layui-form-label" style="padding: 9px 5px;">发起人类别：</label>
				    ...
				    <label class="layui-form-label" style="padding: 9px 5px;">标题：</label>
